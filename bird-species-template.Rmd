...
In the original data, there were 275 "unique" species names. However, that included a lot of spelling mistakes because once the data was cleaned further, spelling mistakes were fixed and only 108 unique names were found in the data set.
